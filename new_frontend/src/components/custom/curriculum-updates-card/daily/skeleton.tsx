    ...
    <div className="tw-w-full">
      <Card className="tw-w-full tw-px-5 tw-py-3 !tw-rounded-3xl tw-flex tw-flex-col tw-gap-[10px]">
        ...
        <div className="tw-flex tw-items-center tw-justify-between">
          <Skeleton className="tw-h-6 tw-w-20 tw-rounded-full tw-bg-[#544DDB]/10" />
        ...
        {/* Notes Row */}
        <div className="tw-flex tw-items-center tw-justify-between">
          <Skeleton className="tw-h-6 tw-w-20 tw-rounded-md tw-bg-gray-300/40" />
          <Skeleton className="tw-h-6 tw-w-6 tw-rounded-full tw-bg-gray-300/40" />
        </div>
      </Card>
    </div>
  );
